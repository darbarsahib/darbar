...
var o__37105__auto___40511 = (function (){var o__37105__auto__ = (function (){var o__37105__auto__ = Promise;
return goog.object.get(o__37105__auto__,"resolve").call(o__37105__auto__);
})();
return goog.object.get(o__37105__auto__,"then").call(o__37105__auto__,callback);
})();
goog.object.get(o__37105__auto___40511,"catch").call(o__37105__auto___40511,devtools.async.rethrow_outside_promise);
...
var G__40513_40514 = Error;
var target__37124__auto___40515 = G__40513_40514;
if(cljs.core.truth_(target__37124__auto___40515)){
} else {
throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str([cljs.core.str("unable to locate object path "),cljs.core.str(null),cljs.core.str(" in "),cljs.core.str(G__40513_40514)].join('')),cljs.core.str("\n"),cljs.core.str("target__37124__auto__")].join('')));
}

goog.object.set(target__37124__auto___40515,cljs.core.last.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["stackTraceLimit"], null)),Infinity);
...
//# sourceMappingURL=async.js.map?rel=1499201001730