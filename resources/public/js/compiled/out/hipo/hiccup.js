...
var or__25979__auto__ = cljs.core.get.call(null,new cljs.core.Keyword(null,"namespaces","namespaces",-1444157469).cljs$core$IFn$_invoke$arity$1(m),s);
...
if((i__$1 > (0))){
var G__31026 = s__$1.replace(hipo.hiccup.class_separator," ");
s__$1 = G__31026;
continue;
} else {
return s__$1;
...
if(cljs.core.truth_((function (){var and__25967__auto__ = id;
...
if(cljs.core.truth_((function (){var or__25979__auto__ = id;
if(cljs.core.truth_(or__25979__auto__)){
return or__25979__auto__;
} else {
return cs;
...
hipo.hiccup.Sentinel.cljs$lang$ctorPrWriter = (function (this__26585__auto__,writer__26586__auto__,opt__26587__auto__){
return cljs.core._write.call(null,writer__26586__auto__,"hipo.hiccup/Sentinel");
});
...
var G__31028 = (function (){var f = cljs.core.first.call(null,s);
if(cljs.core.truth_((function (){var or__25979__auto__ = hipo.hiccup.literal_QMARK_.call(null,f);
if(cljs.core.truth_(or__25979__auto__)){
return or__25979__auto__;
} else {
...
var G__31029 = cljs.core.rest.call(null,s);
v = G__31028;
s = G__31029;
continue;
} else {
...
var G__31030 = ((cljs.core.seq_QMARK_.call(null,f))?hipo.hiccup.conjs_BANG_.call(null,acc,f):((!((f == null)))?cljs.core.conj_BANG_.call(null,acc,f):acc
));
var G__31031 = cljs.core.subvec.call(null,v__$1,(1));
acc = G__31030;
v__$1 = G__31031;
continue;
}
...
//# sourceMappingURL=hiccup.js.map?rel=1499200990387