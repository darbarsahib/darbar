...
return (new CustomEvent(event_name,(function (){var obj33407 = {"detail":data};
return obj33407;
})()));
} else {
...
var args33412 = [];
var len__27054__auto___33418 = arguments.length;
var i__27055__auto___33419 = (0);
while(true){
if((i__27055__auto___33419 < len__27054__auto___33418)){
args33412.push((arguments[i__27055__auto___33419]));

var G__33420 = (i__27055__auto___33419 + (1));
i__27055__auto___33419 = G__33420;
continue;
} else {
}
break;
...
var f = (function (){var pred__33415 = cljs.core._EQ_;
var expr__33416 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__33415.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__33416))){
return ((function (pred__33415,expr__33416){
return (function (p1__33408_SHARP_){
return console.warn(p1__33408_SHARP_);
});
;})(pred__33415,expr__33416))
} else {
if(cljs.core.truth_(pred__33415.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__33416))){
return ((function (pred__33415,expr__33416){
return (function (p1__33409_SHARP_){
return console.debug(p1__33409_SHARP_);
});
;})(pred__33415,expr__33416))
} else {
if(cljs.core.truth_(pred__33415.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__33416))){
return ((function (pred__33415,expr__33416){
return (function (p1__33410_SHARP_){
return console.error(p1__33410_SHARP_);
});
;})(pred__33415,expr__33416))
} else {
return ((function (pred__33415,expr__33416){
return (function (p1__33411_SHARP_){
return console.log(p1__33411_SHARP_);
});
;})(pred__33415,expr__33416))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__33422){
var map__33425 = p__33422;
...
var opts = map__33425__$1;
var eval_fn = cljs.core.get.call(null,map__33425__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__33427_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__33429,(0),null);
...
var args33432 = [];
var len__27054__auto___33435 = arguments.length;
var i__27055__auto___33436 = (0);
while(true){
if((i__27055__auto___33436 < len__27054__auto___33435)){
args33432.push((arguments[i__27055__auto___33436]));

var G__33437 = (i__27055__auto___33436 + (1));
i__27055__auto___33436 = G__33437;
continue;
} else {
}
break;
...
//# sourceMappingURL=utils.js.map?rel=1499200993702